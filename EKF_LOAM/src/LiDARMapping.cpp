...
public:
    ...
    {
        // Subscribers
        subLaserCloudCornerLast = nh.subscribe<sensor_msgs::PointCloud2>("/ekf_loam/laser_cloud_corner_last", 2, &LiDARMapping::laserCloudCornerLastHandler, this);
        subLaserCloudSurfLast = nh.subscribe<sensor_msgs::PointCloud2>("/ekf_loam/laser_cloud_surf_last", 2, &LiDARMapping::laserCloudSurfLastHandler, this);
    ...
    void run(){
           ...
           newLaserOdometry)
        {
            ...
            if (timeLaserOdometry - timeLastProcessing >= mappingProcessInterval) {
                ...
                extractSurroundingKeyFrames(); // Extract surround keyframes of pointcloud (corner, surf, and outilier)

                downsampleCurrentScan(); // downsample pointcoud (corner, surf, and outilier)

                scan2LiDARMapping();  // otimization pointcloud (corner, surf, and outilier) to Map
...
int main(int argc, char** argv)
{
    ...
    ROS_INFO("\033[1;32m---->\033[0m LiDAR Mappinng Started.");
